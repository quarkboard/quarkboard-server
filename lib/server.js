            ...
            if (this.is(plugin)) {
                ...
                this._express.get('/', (req, res, next) => {
                    ...
                    this.app.plugins.filter((plugin) => plugin.enabled).forEach(plugin => {
                        ...
                        this.app.emit('server-scripts', plugin, dom.window.document, dom.window);
                        plugin.scripts(dom.window.document, dom.window);

                        this.app.emit('server-styles', plugin, dom.window.document, dom.window);
                        plugin.styles(dom.window.document, dom.window);
                    });
